...
module.exports =  {
    ...
    makeButtonsForWeapon: function(weapon, level, room = 'battledome', stat = {"A": "10", "M": "10"}){
        ...
        let returnStatement = []; let returnStatement2 = '';
        for (let i = 0; i < abilities.length; i++){
            ...
            let button  = `<button class='button' name='send' value='/msgroom ${room}, ${ability.Name} @ target ${roll} MR ${ability.MR} | secondary effect goes here'>${ability.Name}</button>`;
