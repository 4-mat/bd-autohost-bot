...
module.exports =  {
    ...
    makeButtonsForWeapon: function(weapon, level, room = 'battledome', stat = {"A": "10", "M": "10"}){
        ...
        for (let i = 0; i < abilities.length; i++){
            ...
            let button = `<button class='button' name='send' value='/msgroom ${room}, ${ability.Name} @ target | ${ability.Roll}${attackingStat} | MR ${ability.MR} | secondary effect goes here'>${ability.Name}</button>`;
