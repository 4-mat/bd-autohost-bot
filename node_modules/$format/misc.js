...
module.exports =  {
    ...
    makeButtonsForWeapon: function(weapon, level, room = 'battledome', ){
        ...
        for (let i = 0; i < abilities.length; i++){
            ...
            let attackingStat = (ability.Type === "Magical") ? "+MAG" : (ability.Type === "Physical") ? "+ATK" : "";
            let button = `<button class='button' name='send' value='/msgroom ${room}, ${ability.name} @ target | ' ${ability.Roll}${attackingStat}>${ability.Name} | MR ${ability.MR} | secondary effect goes here'>${ability.name}</button>`;
            returnStatement = returnStatement + button;
        }
        return returnStatement;
    },
    ...
    lockSquad: function(squadNumber){
        let uhtml = require('origindb')('uhtml');  
        room = "battledome-groupchat-" + squadNumber;
        if (room === "battledome-groupchat-main"){
            room = "battledome";
        }
